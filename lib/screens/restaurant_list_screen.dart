...
class _RestaurantListScreenState extends State<RestaurantListScreen>
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ListScreenHeader(
              title: 'Restaurants',
              categoryIconAsset: 'assets/images/restaurant_icon_hub.svg',
          ...
          Expanded(
            child: Consumer<BusinessProvider>(
              builder: (context, provider, child) {
                final businesses = provider.getBusinesses('RESTAURANT');
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTopRestaurantSection(topItem),
                      SizedBox(height: rh(30)),
                      _buildSpecialOffersSection(),
                      SizedBox(height: rh(30)),
                      _buildFrequentlyVisitedSection(frequentlyVisited),
                      SizedBox(height: rh(30)),
                      _buildRestaurantsNearLocationSection(nearbyItems),
                      SizedBox(height: rh(30)),
                    ],
                  ),
                );
  ...
  Widget _buildTopRestaurantSection(BusinessModel item) {
    // Top Restaurant of the month section
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        // Hero Tab 1: Featured restaurant card
        Center(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildFrequentRestaurantCard(frequentlyVisited[index]);
              },
            ),
          ),
        ],
  ...
  Widget _buildFrequentRestaurantCard(BusinessModel item) {
  ...
  Widget _buildRestaurantsNearLocationSection(List<BusinessModel> nearbyItems) {
    if (nearbyItems.isEmpty) return const SizedBox.shrink();
    // Restaurants near your location section
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: rw(15)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildNearbyRestaurantCard(nearbyItems[index]);
            },
          ),
        ],
      ),
  ...
  Widget _buildNearbyRestaurantCard(BusinessModel item) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
