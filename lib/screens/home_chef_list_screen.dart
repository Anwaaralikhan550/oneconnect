...
class HomeChefListScreen extends StatefulWidget {
  const HomeChefListScreen({super.key});

  @override
  State<HomeChefListScreen> createState() => _HomeChefListScreenState();
}

class _HomeChefListScreenState extends State<HomeChefListScreen>
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ListScreenHeader(
              title: 'Home Chefs',
              categoryIconAsset: 'assets/images/home_chef_icon_hub.svg',
          ...
          Expanded(
            child: Consumer<BusinessProvider>(
              builder: (context, provider, child) {
                final businesses = provider.getBusinesses('HOME_CHEF');
                ...
                if (businesses.isEmpty) {
                  return const Center(child: Text('No home chefs found'));
                }
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTopHomeChefSection(topItem),
                      SizedBox(height: rh(30)),
                      _buildSpecialOffersSection(),
                      SizedBox(height: rh(30)),
                      _buildFrequentlyVisitedSection(frequentlyVisited),
                      SizedBox(height: rh(30)),
                      _buildHomeChefsNearLocationSection(nearbyItems),
                      SizedBox(height: rh(30)),
                    ],
                  ),
                );
  ...
  Widget _buildTopHomeChefSection(BusinessModel item) {
    // Top Home Chef of the month section
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        // Hero Tab 1: Featured home chef card
        Center(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: rh(15)),
          // Horizontal scroll of home chef cards
          SizedBox(
            height: rh(181),
            child: ListView.builder(
              scrollDirection: Axis.horizontal,
              ...
              itemBuilder: (context, index) {
                return _buildFrequentHomeChefCard(frequentlyVisited[index]);
              },
            ),
          ),
        ],
  ...
  Widget _buildFrequentHomeChefCard(BusinessModel item) {
  ...
  Widget _buildHomeChefsNearLocationSection(List<BusinessModel> nearbyItems) {
    if (nearbyItems.isEmpty) return const SizedBox.shrink();
    // Home Chefs near your location section
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: rw(15)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          // Vertical list of home chef cards
          ListView.builder(
            shrinkWrap: true,
            physics: const NeverScrollableScrollPhysics(),
            itemCount: nearbyItems.length,
            itemBuilder: (context, index) {
              return _buildNearbyHomeChefCard(nearbyItems[index]);
            },
          ),
        ],
      ),
  ...
  Widget _buildNearbyHomeChefCard(BusinessModel item) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
