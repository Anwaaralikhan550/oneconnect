...
class _BankListScreenState extends State<BankListScreen>
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ListScreenHeader(
              title: 'Banks',
              categoryIconAsset: 'assets/images/bank_icon_hub.svg',
          ...
          Expanded(
            child: Consumer<BusinessProvider>(
              builder: (context, provider, child) {
                final businesses = provider.getBusinesses('BANK');
  ...
  Widget _buildTopBankSection(BusinessModel item) {
    // Top Bank of the month section
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
...
'name': item.name,
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildFrequentBankCard(frequentlyVisited[index]);
              },
            ),
          ),
        ],
  ...
  Widget _buildFrequentBankCard(BusinessModel item) {
...
'name': item.name,
  ...
  Widget _buildBanksNearLocationSection(List<BusinessModel> nearbyItems) {
    if (nearbyItems.isEmpty) return const SizedBox.shrink();
    // Banks near your location section
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: rw(15)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          // Vertical list of bank cards
          ListView.builder(
            shrinkWrap: true,
            physics: const NeverScrollableScrollPhysics(),
            itemCount: nearbyItems.length,
            itemBuilder: (context, index) {
              return _buildNearbyBankCard(nearbyItems[index]);
            },
          ),
        ],
      ),
  ...
  Widget _buildNearbyBankCard(BusinessModel item) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
