...
class _GasScreenState extends State<GasScreen>
  ...
  void initState() {
    super.initState();
    // Fetch gas service providers from backend
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ServiceProviderProvider>(context, listen: false)
          .fetchByType('GAS', force: true);
    });
  }
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            ListScreenHeader(
              title: 'Gas Services',
              categoryIconAsset: 'assets/icons/gas_header_icon.svg',
            ...
            Expanded(
              child: Consumer<ServiceProviderProvider>(
                builder: (context, provider, child) {
                  final items = provider.getProviders('GAS');
                  ...
                  if (items.isEmpty) {
                    return const Center(
                      child: Text('No gas services found'),
                    );
                  }
