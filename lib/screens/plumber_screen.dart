      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            ListScreenHeader(
              title: 'Plumbers',
              categoryIconAsset: 'assets/icons/plumber_header_icon.svg',
              iconWidth: 89,
              iconHeight: 89,
            ...
            Expanded(
              child: Consumer<ServiceProviderProvider>(
                builder: (context, provider, child) {
                  final items = provider.getProviders('PLUMBER');
