...
class _WaterScreenState extends State<WaterScreen>
  ...
  void initState() {
    super.initState();
    // Fetch water service providers from backend
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ServiceProviderProvider>(context, listen: false)
          .fetchByType('WATER', force: true);
    });
  }
        ...
        child: Column(
          children: [
            ...
            ListScreenHeader(
              ...
              categoryIconAsset: 'assets/icons/water_header_icon.svg',
            ...
            Expanded(
              child: Consumer<ServiceProviderProvider>(
                builder: (context, provider, child) {
                  final items = provider.getProviders('WATER');
                  ...
                  if (items.isEmpty) {
                    return const Center(
                      child: Text('No water services found'),
                    );
                  }
