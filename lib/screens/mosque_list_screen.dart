...
class _MosqueListScreenState extends State<MosqueListScreen>
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ListScreenHeader(
              title: 'Mosques',
              categoryIconAsset: 'assets/images/mosque_icon_hub.svg',
              onSearch: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SearchScreen())),
            ),
          Expanded(
            child: Consumer<BusinessProvider>(
              builder: (context, provider, child) {
                final amenities = provider.getAmenities('MASJID');
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTopMosqueSection(topItem),
                      SizedBox(height: rh(30)),
                      _buildSpecialOffersSection(),
                      SizedBox(height: rh(30)),
                      _buildFrequentlyVisitedSection(frequentlyVisited),
                      SizedBox(height: rh(30)),
                      _buildMosquesNearLocationSection(nearbyItems),
                      SizedBox(height: rh(30)),
                    ],
                  ),
                );
  ...
  Widget _buildTopMosqueSection(AmenityModel mosque) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          ...
          child: Row(
            children: [
              ...
              Flexible(child: Text('Top Mosque of the month', style: GoogleFonts.inter(fontSize: rfs(18), fontWeight: FontWeight.w700, color: Colors.black, letterSpacing: 0.112, height: 1.2), overflow: TextOverflow.ellipsis)),
            ],
          ),
        ),
        ...
        Center(
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => MosqueDetailScreen(mosqueData: {
              'id': mosque.id,
              'name': mosque.name,
              'rating': mosque.rating.toStringAsFixed(1),
              'reviews': mosque.reviewCount.toString(),
              'location': mosque.location ?? '',
              'isOpen': mosque.isOpen,
              'image': mosque.imageUrl,
            }))),
            child: Container(
              width: rw(355),
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: SizedBox(
                            width: rw(343),
                            height: rh(135),
                            child: buildProfileImage(mosque.imageUrl, fallbackIcon: Icons.mosque, iconSize: rw(50)),
                          ),
                        ),
                        Positioned(top: rh(6), left: rw(5), child: Container(padding: EdgeInsets.symmetric(horizontal: rw(5), vertical: rh(5)), decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(rw(14))), child: Row(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.star, size: rw(20), color: const Color(0xFFFFCD29)), SizedBox(width: rw(2)), Text(mosque.rating.toStringAsFixed(1), style: GoogleFonts.roboto(fontSize: rfs(12), fontWeight: FontWeight.w500, color: Colors.black)), SizedBox(width: rw(2)), Text('(${mosque.reviewCount})', style: GoogleFonts.inter(fontSize: rfs(10), fontWeight: FontWeight.w500, color: Colors.black))]))),
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(mosque.name, style: GoogleFonts.oswald(fontSize: rfs(16), fontWeight: FontWeight.w400, color: Colors.black)),
                          Row(children: [SvgPicture.asset('assets/icons/figma_location_icon.svg', width: rw(17), height: rw(17), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(17), color: Colors.grey)), Text(mosque.location ?? '', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: Colors.black))]),
                        ]),
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Row(mainAxisSize: MainAxisSize.min, children: [SvgPicture.asset('assets/icons/figma_open_door_icon.svg', width: rw(24), height: rw(24), placeholderBuilder: (context) => Icon(Icons.door_front_door, size: rw(24), color: const Color(0xFF073A6A))), Text(mosque.isOpen ? 'Open' : 'Closed', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: mosque.isOpen ? const Color(0xFF073A6A) : Colors.red))]),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Spacer(),
                  Row(children: [Text(offer['salePrice'], style: GoogleFonts.poppins(fontSize: rfs(12), fontWeight: FontWeight.w600, color: const Color(0xFFFF5571))), SizedBox(width: rw(8)), if (offer['originalPrice'].isNotEmpty) Text(offer['originalPrice'], style: GoogleFonts.poppins(fontSize: rfs(12), fontWeight: FontWeight.w600, color: const Color(0xFF929292), decoration: TextDecoration.lineThrough))]),
                ],
              ),
            ),
          ),
  ...
  Widget _buildFrequentlyVisitedCard(AmenityModel mosque) {
        ...
        child: Column(
          children: [
            SizedBox(
              ...
              child: Stack(
                children: [
                  ClipRRect(borderRadius: BorderRadius.circular(rw(20)), child: SizedBox(width: rw(302), height: rh(118), child: buildProfileImage(mosque.imageUrl, fallbackIcon: Icons.mosque, iconSize: rw(40)))),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(mosque.name, style: GoogleFonts.oswald(fontSize: rfs(15), fontWeight: FontWeight.w400, color: Colors.black)), Row(children: [SvgPicture.asset('assets/icons/figma_location_icon.svg', width: rw(17), height: rw(17), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(17), color: Colors.grey)), Text(mosque.location ?? '', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w300, color: Colors.black))])]),
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisSize: MainAxisSize.min, children: [SvgPicture.asset('assets/icons/figma_open_door_icon.svg', width: rw(24), height: rw(24), placeholderBuilder: (context) => Icon(Icons.door_front_door, size: rw(24), color: const Color(0xFF073A6A))), Text(mosque.isOpen ? 'Open' : 'Closed', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: mosque.isOpen ? const Color(0xFF073A6A) : Colors.red))]), Row(mainAxisSize: MainAxisSize.min, children: [SvgPicture.asset('assets/icons/figma_map_icon.svg', width: rw(24), height: rw(24), placeholderBuilder: (context) => Icon(Icons.map, size: rw(24), color: const Color(0xFF6A6A6A))), SizedBox(width: rw(1)), Text('Map', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: const Color(0xFF073A6A)))])]),
                ],
              ),
            ),
          ],
  ...
  Widget _buildMosquesNearLocationSection(List<AmenityModel> items) {
    if (items.isEmpty) return const SizedBox.shrink();
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          padding: EdgeInsets.symmetric(horizontal: rw(20)),
          child: Row(children: [SvgPicture.asset('assets/icons/figma_location_filled_icon.svg', width: rw(25), height: rw(25), colorFilter: const ColorFilter.mode(Color(0xFF0097B2), BlendMode.srcIn), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(25), color: const Color(0xFF0097B2))), SizedBox(width: rw(15)), Text('Mosques near your location', style: GoogleFonts.inter(fontSize: rfs(18), fontWeight: FontWeight.w700, color: Colors.black, letterSpacing: 0.112, height: 1.2))]),
        ),
        SizedBox(height: rh(20)),
        Padding(padding: EdgeInsets.symmetric(horizontal: rw(15)), child: Column(children: items.map((mosque) => Padding(padding: EdgeInsets.only(bottom: rh(20)), child: _buildNearbyMosqueCard(mosque))).toList())),
      ],
    );
  }

  Widget _buildNearbyMosqueCard(AmenityModel mosque) {
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => MosqueDetailScreen(mosqueData: {
        'id': mosque.id,
        'name': mosque.name,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ClipRRect(borderRadius: BorderRadius.circular(rw(100)), child: SizedBox(width: rw(81), height: rw(81), child: buildProfileImage(mosque.imageUrl, fallbackIcon: Icons.mosque, iconSize: rw(30)))),
            SizedBox(width: rw(10)),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(mosque.name, style: GoogleFonts.inter(fontSize: rfs(15), fontWeight: FontWeight.w600, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                  Row(children: [SvgPicture.asset('assets/icons/figma_location_icon.svg', width: rw(17), height: rw(17), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(17), color: Colors.grey)), Text(mosque.location ?? '', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w300, color: Colors.black))]),
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(children: List.generate(5, (index) => Icon(index < mosque.rating.round() ? Icons.star : Icons.star_border, size: rw(15), color: const Color(0xFFFFCD29)))), SizedBox(height: rh(4)), Row(children: [Text(mosque.rating.toStringAsFixed(1), style: GoogleFonts.inter(fontSize: rfs(12), fontWeight: FontWeight.w500, color: const Color(0xFF353535), letterSpacing: 0.168)), SizedBox(width: rw(3)), Text('(${mosque.reviewCount} Reviews)', style: GoogleFonts.inter(fontSize: rfs(12), fontWeight: FontWeight.w500, color: const Color(0xFF353535), letterSpacing: 0.168))])]),
                ],
              ),
            ),
