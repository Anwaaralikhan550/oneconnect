...
class _GymListScreenState extends State<GymListScreen>
  ...
  Widget _buildTopGymSection(AmenityModel gym) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          ...
          child: Row(
            children: [
              ...
              Flexible(child: Text('Top Gym of the month', style: GoogleFonts.inter(fontSize: rfs(18), fontWeight: FontWeight.w700, color: Colors.black, letterSpacing: 0.112, height: 1.2), overflow: TextOverflow.ellipsis)),
            ],
          ),
        ),
        ...
        Center(
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => GymDetailScreen(gymData: {
              'id': gym.id,
              'name': gym.name,
              'rating': gym.rating.toStringAsFixed(1),
              'reviews': gym.reviewCount.toString(),
                    ...
                    child: Stack(
                      children: [
                        ClipRRect(
                          ...
                          child: SizedBox(width: rw(343), height: rh(135), child: buildProfileImage(gym.imageUrl, fallbackIcon: Icons.fitness_center, iconSize: rw(50))),
                        ),
                        Positioned(top: rh(6), left: rw(5), child: Container(padding: EdgeInsets.symmetric(horizontal: rw(5), vertical: rh(5)), decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(rw(14))), child: Row(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.star, size: rw(20), color: const Color(0xFFFFCD29)), SizedBox(width: rw(2)), Text(gym.rating.toStringAsFixed(1), style: GoogleFonts.roboto(fontSize: rfs(12), fontWeight: FontWeight.w500, color: Colors.black)), SizedBox(width: rw(2)), Text('(${gym.reviewCount})', style: GoogleFonts.inter(fontSize: rfs(10), fontWeight: FontWeight.w500, color: Colors.black))]))),
                      ...
                      children: [
                        Flexible(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(gym.name, style: GoogleFonts.oswald(fontSize: rfs(16), fontWeight: FontWeight.w400, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                            Row(children: [SvgPicture.asset('assets/icons/figma_location_icon.svg', width: rw(17), height: rw(17), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(17), color: Colors.grey)), Flexible(child: Text(gym.location ?? '', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis))]),
                          ]),
                        ),
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Row(mainAxisSize: MainAxisSize.min, children: [SvgPicture.asset('assets/icons/figma_open_door_icon.svg', width: rw(24), height: rw(24), placeholderBuilder: (context) => Icon(Icons.door_front_door, size: rw(24), color: const Color(0xFF073A6A))), Text(gym.isOpen ? 'Open' : 'Closed', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: gym.isOpen ? const Color(0xFF073A6A) : Colors.red))]),
  ...
  Widget _buildFrequentlyVisitedCard(AmenityModel gym) {
        ...
        child: Column(
          children: [
            SizedBox(
              ...
              child: Stack(
                children: [
                  ClipRRect(borderRadius: BorderRadius.circular(rw(20)), child: SizedBox(width: rw(302), height: rh(118), child: buildProfileImage(gym.imageUrl, fallbackIcon: Icons.fitness_center, iconSize: rw(40)))),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Flexible(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(gym.name, style: GoogleFonts.oswald(fontSize: rfs(15), fontWeight: FontWeight.w400, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis), Row(children: [SvgPicture.asset('assets/icons/figma_location_icon.svg', width: rw(17), height: rw(17), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(17), color: Colors.grey)), Flexible(child: Text(gym.location ?? '', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w300, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis))])])),
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisSize: MainAxisSize.min, children: [SvgPicture.asset('assets/icons/figma_open_door_icon.svg', width: rw(24), height: rw(24), placeholderBuilder: (context) => Icon(Icons.door_front_door, size: rw(24), color: const Color(0xFF073A6A))), Text(gym.isOpen ? 'Open' : 'Closed', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: gym.isOpen ? const Color(0xFF073A6A) : Colors.red))]), Row(mainAxisSize: MainAxisSize.min, children: [SvgPicture.asset('assets/icons/figma_map_icon.svg', width: rw(24), height: rw(24), placeholderBuilder: (context) => Icon(Icons.map, size: rw(24), color: const Color(0xFF6A6A6A))), SizedBox(width: rw(1)), Text('Map', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w400, color: const Color(0xFF073A6A)))])]),
                ],
              ),
            ),
          ],
  ...
  Widget _buildGymsNearLocationSection(List<AmenityModel> items) {
    if (items.isEmpty) return const SizedBox.shrink();
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          padding: EdgeInsets.symmetric(horizontal: rw(20)),
          child: Row(children: [SvgPicture.asset('assets/icons/figma_location_filled_icon.svg', width: rw(25), height: rw(25), colorFilter: const ColorFilter.mode(Color(0xFF0097B2), BlendMode.srcIn), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(25), color: const Color(0xFF0097B2))), SizedBox(width: rw(15)), Flexible(child: Text('Gyms near your location', style: GoogleFonts.inter(fontSize: rfs(18), fontWeight: FontWeight.w700, color: Colors.black, letterSpacing: 0.112, height: 1.2), overflow: TextOverflow.ellipsis))]),
        ),
        SizedBox(height: rh(20)),
        Padding(padding: EdgeInsets.symmetric(horizontal: rw(15)), child: Column(children: items.map((gym) => Padding(padding: EdgeInsets.only(bottom: rh(20)), child: _buildNearbyGymCard(gym))).toList())),
      ],
    );
  }

  Widget _buildNearbyGymCard(AmenityModel gym) {
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => GymDetailScreen(gymData: {
        'id': gym.id,
        'name': gym.name,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ClipRRect(borderRadius: BorderRadius.circular(rw(100)), child: SizedBox(width: rw(81), height: rw(81), child: buildProfileImage(gym.imageUrl, fallbackIcon: Icons.fitness_center, iconSize: rw(30)))),
            SizedBox(width: rw(10)),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(gym.name, style: GoogleFonts.inter(fontSize: rfs(15), fontWeight: FontWeight.w600, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                  Row(children: [SvgPicture.asset('assets/icons/figma_location_icon.svg', width: rw(17), height: rw(17), placeholderBuilder: (context) => Icon(Icons.location_on, size: rw(17), color: Colors.grey)), Flexible(child: Text(gym.location ?? '', style: GoogleFonts.oswald(fontSize: rfs(11), fontWeight: FontWeight.w300, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis))]),
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(children: List.generate(5, (index) => Icon(index < gym.rating.round() ? Icons.star : Icons.star_border, size: rw(15), color: const Color(0xFFFFCD29)))), SizedBox(height: rh(4)), Row(children: [Text(gym.rating.toStringAsFixed(1), style: GoogleFonts.inter(fontSize: rfs(12), fontWeight: FontWeight.w500, color: const Color(0xFF353535), letterSpacing: 0.168)), SizedBox(width: rw(3)), Flexible(child: Text('(${gym.reviewCount} Reviews)', style: GoogleFonts.inter(fontSize: rfs(12), fontWeight: FontWeight.w500, color: const Color(0xFF353535), letterSpacing: 0.168), maxLines: 1, overflow: TextOverflow.ellipsis))])]),
                ],
              ),
            ),
