...
class _LaundryScreenState extends State<LaundryScreen>
  ...
  void initState() {
    super.initState();
    // Fetch laundry services from backend
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ServiceProviderProvider>(context, listen: false)
          .fetchByType('LAUNDRY', force: true);
    });
  }

  @override
  Widget build(BuildContext context) {
    debugPrint('DEBUG: [Laundry] screen opened');
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            ListScreenHeader(
              title: 'Laundry',
              categoryIconAsset: 'assets/icons/laundry_header_icon.svg',
              iconWidth: 109,
              iconHeight: 109,
              iconOffsetY: 10,
            ...
            Expanded(
              child: Consumer<ServiceProviderProvider>(
                builder: (context, provider, child) {
                  final items = provider.getProviders('LAUNDRY');
                  ...
                  if (items.isEmpty) {
                    return const Center(
                      child: Text('No laundry services found'),
                    );
                  }
